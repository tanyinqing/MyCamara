package glidedisanfang.tyq.com.tanaar_171207;
...
import glidedisanfang.tyq.com.tanaar_171207.exception.CrashHandler;
import glidedisanfang.tyq.com.tanaar_171207.util.PreferenceUtil;
import glidedisanfang.tyq.com.tanaar_171207.util_Jar.Utils;
...
public class ServiceApplication extends Application {
	...
	public void saveUser(User u)
	{
		...
		if (u!= null) {
		/*	mPrefUtil.putSetting("U_Id",u.getId());
	...
	//记忆常规登录参数
	/*public void updateLoginParams(User_andbass user) {
		mUser = user;
